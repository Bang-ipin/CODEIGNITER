...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyBpsKTOHJCfzHRdr-65mm5zKBMHelCzzqM'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $sensor						= '';						// Set to TRUE if being used on a device that can detect a users location
