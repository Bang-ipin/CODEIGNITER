<script src="<?=base_url('assets/global/plugins/tinymce/tinymce.min.js');?>" type="text/javascript" ></script>
		<script src="<?=base_url('assets/global/plugins/tinymce/jquery.tinymce.min.js');?>" type="text/javascript" ></script>
