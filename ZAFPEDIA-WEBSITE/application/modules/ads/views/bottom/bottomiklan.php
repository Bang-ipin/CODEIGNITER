<div class="row">
					...
					<?=form_open('ads/advertising/addadscustom',array('id'=>'formadscustom','class'=>'form-horizontal form-row-stripped'));?>
	                    <div class="form-group">
							<div class="col-md-10">
								...
								<input class="form-control" type="hidden" name="type-ads-custom" id="type-ads-custom" value="2">
						...
						<div class="form-group">
							<div class="col-md-10">
								...
								<img src="<?=base_url();?>/assets/admin/layout/img/no-image.jpg" id="previewimage" style="height:100px;width:100px;"/><br/><br/>
	...
	<div class="col-md-8">
		<div class="portlet box yellow">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-list"></i>Bottom Iklan
				</div>
			</div>
