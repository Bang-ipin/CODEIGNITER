...
class Articles extends CI_Controller {
	...
	public function simpan() {
		...
		if(!empty($cek)){
			...
			$blog					= ucwords($this->input->post('judul_blog',null,TRUE));
			$kategori				= $this->input->post('kategori',null,TRUE); 
			$status					= $this->input->post('status',null,TRUE); 
			$isi_blog				= $this->input->post('isi_blog',null,TRUE); 
			$meta_deskripsi			= $this->input->post('meta_deskripsi',null,TRUE); 
			$meta_keyword			= $this->input->post('meta_keyword',null,TRUE); 
