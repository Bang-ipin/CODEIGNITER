				...
				<div class="table-container">
					<table class="table table-striped table-bordered table-hover" >
						...
						<tbody>
							...
							<td align="center">
								<a href="javascript:;" data-url="<?=site_url($pages['laman_seo']);?>" data-type="1" data-title="<?=$pages['nama_laman'];?>" class="tambahkan-ke-menu btn btn-sm btn-primary" title="Tambahkan ke Menu"><i class='fa fa-sign-out'></i> </a>
							</td>
						</tbody>
							<?php
							$no++;
				...
				<div class="table-container">
					<table class="table table-striped table-bordered table-hover" >
						...
						<tbody>
							<td><?=$cat['kategori'];?></td>
							<td align="center">
								<a href="javascript:;" data-type="1" data-url="<?=site_url('produk/'.$cat['kategori_seo']);?>" data-title="<?=$cat['kategori'];?>" class="tambahkan-ke-menu btn btn-sm btn-primary" title="Tambahkan ke Menu"><i class="fa fa-sign-out"></i>
								</a>
							</td>
						</tbody>
						<?php
