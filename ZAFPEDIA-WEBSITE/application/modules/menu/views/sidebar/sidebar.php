...
<div class="row">
					...
					<?=form_open('menu/menu/addmenucustom',array('id'=>'formmenucustom','class'=>'form-horizontal form-row-stripped'));?>
	                    <div class="form-group">
							<div class="col-md-10">
								...
								<input class="form-control" type="hidden" name="type-menu-custom" id="type-menu-custom" value="2" required>
				...
				<div class="table-container">
					<table class="table table-striped table-bordered table-hover" >
						...
						<tbody>
							...
							<td align="center">
								<a href="javascript:;" data-type="2" data-url="<?=site_url($pages['laman_seo']);?>" data-title="<?=$pages['nama_laman'];?>" class="tambahkan-ke-menu btn btn-sm btn-primary" title="Tambahkan ke Menu"><i class='fa fa-sign-out'></i> </a>
							</td>
						</tbody>
							<?php
							$no++;
				...
				<div class="table-container">
					<table class="table table-striped table-bordered table-hover" >
						...
						<tbody>
							<td><?=$cat['kategori'];?></td>
							<td align="center">
								<a href="javascript:;" data-type="2" data-url="<?=site_url('produk/'.$cat['kategori_seo']);?>" data-title="<?=$cat['kategori'];?>" class="tambahkan-ke-menu btn btn-sm btn-primary" title="Tambahkan ke Menu"><i class="fa fa-sign-out"></i>
								</a>
							</td>
						</tbody>
						<?php
	...
	<div class="col-md-8">
		<div class="portlet box yellow">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-list"></i>Sidebar Menu
				</div>
				<div class="tools">
					<a href="javascript:;" class="expand"></a>
					<a href="javascript:;" class="reload"></a>
