...
class Config extends CI_Controller {
	...
	public function index() 
	{
		...
		if(!empty($cek)){
			...
			$data['googleplus']			= $config['googleplus'];
			$data['tumblr']				= $config['tumblr'];
			$data['linkedin']			= $config['linkedin'];
			$data['youtube']			= $config['youtube'];
			$data['vimeo']				= $config['vimeo'];
			$data['skype']				= $config['skype'];
			$data['javascript_header']	= $config['javascript_header'];
            $data['javascript_footer']	= $config['javascript_footer'];
		    $data['hak_cipta']			= $config['hak_cipta'];
			$data['provinsi']			= $config['provinsi'];
			$data['kotaasal']           = $this->Config_model->get_city();
			...
			if($check_file_upload && !$this->upload->do_upload('favicon')) {
				...
				if(!$this->upload->do_upload('favicon'))
				{
					$data = array(
						...
						'javascript_header' => $this->input->post('javascript_header'),
						'javascript_footer' => $this->input->post('javascript_footer'),
					);
						$id						= $this->input->post('id',null,TRUE);
			        	$d						= $this->db->get_where('setting',array('id_config'=>$id));
