...
<?php } ?>
<table class="table table-striped table-bordered table-hover" id="listordersall">
	<thead>
	...
	<tbody>
		...
		<tr data-messageid ="<?=$order['id'];?>">
			...
			<td class="text-right">
				...
				<?php } ?>
				<?php if ($order['status_pesanan']==2){ ?>
				<a href="<?=site_url('appweb/orders/cancel/'.$order['id'].'/0');?>" class="btn btn-sm btn-warning btn-editable" title="Cancel">
					<i class="fa fa-ban"></i> 
				</a>
				<?php }else{ ?>
				<a href="<?=site_url('appweb/orders/cancel/'.$order['id'].'/2');?>" class="btn btn-sm btn-warning btn-editable" title="Cancel">
					<i class="fa fa-ban"></i> 
				</a>
				<?php } ?>
				<a href="<?=site_url('appweb/orders/hapus/'.$order['invoice']);?>" class="btn btn-sm btn-danger btn-editable"  title="Hapus" >
