...
<?php } ?>
<table class="table table-striped table-bordered table-hover" id="listorderspending">
	<thead>
			...
			<td class="view-order">
				<?php 
					if($order['status_pesanan']==0){
						...
						$statusodr = "<span class='label label-warning'>Cancel</span>";
					}else{
						$statusodr = "<span class='label label-danger'>Reject</span>";
					}
				?>
				<?=$statusodr;?>
			</td>
