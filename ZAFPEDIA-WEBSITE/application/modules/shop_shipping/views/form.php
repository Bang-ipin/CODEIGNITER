		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject uppercase">Shipping</span>
				</div>
			</div>
			<div class="portlet-body form">
				<div class="form-body">
					<?php echo form_open_multipart('shop_shipping/shippings/simpan',array('id'=>'formshipping','class'=>'form-horizontal form-bordered form-row-stripped'));?>
						...
						<div class="form-actions">
							<div class="row">
								<div class="col-md-offset-8 col-md-4">
									<a href="<?=site_url('appweb/shippings');?>" class="btn btn-danger btn-sm btn-circle" name="back"><i class="fa fa-angle-left"></i> Back</a>
