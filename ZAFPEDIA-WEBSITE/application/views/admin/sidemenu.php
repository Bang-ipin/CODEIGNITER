			...
			<div class="page-sidebar-wrapper">
				<div class="page-sidebar navbar-collapse collapse">
					<ul class="page-sidebar-menu page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
						...
						<?php
							$t = "SELECT count(*) as jml FROM ulasan WHERE dibaca=0 AND status=0";
							$d = $this->db->query($t);
							$r = $d->num_rows();
							if($r > 0){
						...
						<li class="nav-item">
							<a href="javascript:;" class="nav-link nav-toggle">
								...
								<span class="title">Toko <?php if(!empty($ulasan)){
							...
							<ul class="sub-menu">
								<li class="nav-item">
									...
									<ul class="sub-menu">
										<li class="nav-item">
											<a href="<?php echo site_url('appweb/category-product');?>" class="nav-link">
												<span class="title">Kategori</span>
											</a>
										</li>
										<li class="nav-item">
											<a href="<?php echo site_url('appweb/category-product/add');?>" class="nav-link">
								...
								<li>
									...
									<ul class="sub-menu">
										<li class="nav-item">
											<a href="<?php echo site_url('appweb/products');?>" class="nav-link">
												<span class="title">Semua Produk</span>
											</a>
										</li>
										<li class="nav-item">
											<a href="<?php echo site_url('appweb/products/add');?>" class="nav-link">
								...
								<li class="nav-item">
									<a href="<?=site_url('appweb/atributs');?>" class="nav-link">
										<span class="title">Atribut</span>
									</a>
								</li>
								<li class="nav-item">
									<a href="<?=site_url('appweb/supplier');?>" class="nav-link">
										<span class="title">Supplier</span>
									</a>
								</li>
								<li class="nav-item">
									<a href="<?=site_url('appweb/review-product');?>"> 
						...
						<li class="nav-item">
							...
							<a href="javascript:;" class="nav-link nav-toggle">
								...
								<span class="title">Penjualan <?php if(!empty($orderbaru)){
									echo "<span class='badge badge-danger'>".$orderbaru."</span>"; 
								} ?></span>
								<span class="arrow "></span>
							</a>
							<ul class="sub-menu">
								<li class="nav-item">
									<a href="<?=site_url('appweb/orders');?>" class="nav-link">
										<span class="title">Pesanan <?php if(!empty($orderbaru)){
										echo "<span class='badge badge-danger pull-right'>".$orderbaru."</span>"; 
									} ?></span>
									</a>	
								</li>
							</ul>
						...
						<li>
							...
							<ul class="sub-menu">
								<li class="nav-item">
									<a href="<?=site_url('appweb/menu');?>" class="nav-link">
								...
								<li class="nav-item">
									<a href="<?=site_url('appweb/payments');?>" class="nav-link">
										<span class="title">Pembayaran</span>
									</a>
								</li>
								<li class="nav-item">
									<a href="<?=site_url('appweb/members');?>" class="nav-link">
						...
						<li class="nav-item">
							<a href="javascript:;" class="nav-link nav-toggle">
								...
								<span class="title">Blog <?php if(!empty($komentarbelumterbuka)){
							...
							<ul class="sub-menu">
								<li class="nav-item">
									<a href="<?=site_url('appweb/categories');?>" class="nav-link">
										<span class="title">Kategori</span>
									</a>
								</li>
								<li class="nav-item">
									<a href="<?=site_url('appweb/articles');?>" class="nav-link">
						...
						<li class="nav-item">
							...
							<ul class="sub-menu">
								...
								<li class="nav-item">
									<a href="<?=site_url('appweb/themes/background');?>" class="nav-link">
										<span class="title">Background Tema</span>
									</a>
								</li>
								<li class="nav-item">
						...
						<li class="nav-item">
							...
							<ul class="sub-menu">
								<li class="nav-item">
									<a href="components_ion_sliders" class="nav-link">
										<span class="title">Laporan</span>
									</a>
								</li>
								<li class="nav-item">
									<a href="components_noui_sliders" class="nav-link">
										<span class="title">Orang Yang Online</span>
									</a>
								</li>
								<li class="nav-item">
									<a href="components_jqueryui_sliders" class="nav-link">
