...
<html lang="en">
	<head>
		...
		<link href="<?=base_url('assets/plugins/rateit/src/rateit.css');?>" rel="stylesheet" type="text/css">
		<link href="<?=base_url('assets/global/plugins/simple-line-icons/simple-line-icons.min.css');?>" rel="stylesheet" type="text/css">
		<link href="<?=base_url('assets/global/plugins/slider-layer-slider/css/layerslider.css');?>" rel="stylesheet">
		...
		<link href="<?=base_url('assets/admin/pages/css/blog.css');?>" rel="stylesheet" type="text/css"/>
		<link href="<?=base_url('assets/admin/pages/css/news.css');?>" rel="stylesheet" type="text/css"/>
		...
		<link href="<?=base_url('assets/pages/css/tasks.css');?> rel="stylesheet');?>" type="text/css"/>
		<link href="<?=base_url('assets/global/css/components-md.css');?>" id="style_components" rel="stylesheet">
		<link href="<?=base_url('assets/global/css/plugins-md.css');?>" rel="stylesheet">
		...
		<link href="<?=base_url('assets/frontend/pages/css/style-layer-slider.css');?>" rel="stylesheet">
		<link href="<?=base_url('assets/frontend/layout/css/style-responsive.css');?>" rel="stylesheet">
		<link href="<?=base_url('assets/frontend/layout/css/themes/blue.css');?>" rel="stylesheet" id="style-color">
		<link href="<?=base_url('assets/frontend/layout/css/custom.css');?>" rel="stylesheet" id="style-color">
		<!-- Theme styles END -->
	</head>
	<body class="page-404-full-page">
		...
		<script src="<?=base_url('assets/plugins/validation/dist/jquery.validate.js')?>" type="text/javascript" ></script>
		<script src="<?=base_url('assets/plugins/validation/dist/additional-methods.min.js')?>" type="text/javascript" ></script>
		<script src="<?=base_url('assets/plugins/rateit/src/jquery.rateit.js')?>" type="text/javascript"></script>
		<script src="<?=base_url('assets/plugins/gmaps/gmaps.js');?>" type="text/javascript"></script>
		...
		<!-- BEGIN LayerSlider -->
		<script src="<?=base_url('assets/global/plugins/slider-layer-slider/js/greensock.js')?>" type="text/javascript"></script><!-- External libraries: GreenSock -->
		<script src="<?=base_url('assets/global/plugins/slider-layer-slider/js/layerslider.transitions.js')?>" type="text/javascript"></script><!-- LayerSlider script files -->
		<script src="<?=base_url('assets/global/plugins/slider-layer-slider/js/layerslider.kreaturamedia.jquery.js')?>" type="text/javascript"></script><!-- LayerSlider script files -->
		<script src="<?=base_url('assets/frontend/pages/scripts/layerslider-init.js')?>" type="text/javascript"></script>
		<script src="<?=base_url('assets/global/plugins/jquery-mixitup/jquery.mixitup.min.js');?>" type="text/javascript"></script>
		<!-- END LayerSlider -->
		...
		<script src="<?=base_url('assets/pages/scripts/contact-us.js')?>" type="text/javascript"></script>
