	...
	<div class="col-md-12">
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				<div class="form-body">
					<?php echo form_open_multipart('blogs/articles/simpan',array('id'=>'formartikel','class'=>'form-horizontal form-row-stripped form-bordered'));?>
						<div class="form-group">
							...
							<div class="col-md-10">
								...
								<input class="form-control" type="text" name="judul_blog" id="judul_blog" value="<?php echo $judul_blog; ?>">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<textarea class="form-control editor1" type="text" name="isi_blog" data-error-container="#isi_blog"><?php echo $isi_blog; ?></textarea>
								<div id="isi_blog"></div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-actions">
							<div class="row">
								<div class="col-md-offset-8 col-md-4">
									<a href="<?=site_url('appweb/articles');?>" class="btn btn-danger btn-sm btn-circle" name="back"><i class="fa fa-angle-left"></i> Back</a>
