...
jQuery(document).ready(function(){
	...
	var loadKomentar = function (el, name) {
		var url = '<?=site_url('comments/comments/show_komentar');?>';
	...
	var loadSent = function (el, name) {
		var url = '<?=site_url('comments/comments/show_sent');?>';
		var title = $('.komentar-nav > li.' + name + ' a').attr('data-title');
		listListing = name;
	...
	var loadTrash = function (el, name) {
		var url = '<?=site_url('comments/comments/show_trash');?>';
		var title = $('.komentar-nav > li.' + name + ' a').attr('data-title');
		listListing = name;
	...
	function loadMessage(el, name, resetMenu) {
		var url = '<?=site_url('comments/comments/view_komentar');?>';
	...
	function loadReply(el) {
		...
		var url = '<?=site_url('comments/comments/balas_komentar');?>';
