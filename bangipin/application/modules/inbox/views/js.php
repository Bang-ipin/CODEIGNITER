<script src="<?=base_url('assets/plugins/datatables/datatables.min.js');?>" type="text/javascript" ></script>
		...
		<script src="<?=base_url('assets/plugins/jquery-file-upload/blueimp-gallery/jquery.blueimp-gallery.min.js');?>"></script>
		<script src="<?=base_url('assets/plugins/jquery-file-upload/js/vendor/jquery.ui.widget.js');?>"></script>
		<script src="<?=base_url('assets/plugins/jquery-file-upload/js/vendor/tmpl.min.js');?>"></script>
		<script src="<?=base_url('assets/plugins/jquery-file-upload/js/vendor/load-image.min.js');?>"></script>
		<script src="<?=base_url('assets/plugins/jquery-file-upload/js/vendor/canvas-to-blob.min.js');?>"></script>
