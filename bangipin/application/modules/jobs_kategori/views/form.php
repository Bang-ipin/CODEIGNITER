		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject bold uppercase">Kategori Pekerjaan</span>
				</div>
			</div>
			<div class="portlet-body form">
				<?php echo form_open('jobs_kategori/category_jobs/simpan_kategori',array('id'=>"formkategorijobs",'class'=>'form-horizontal form-bordered form-row-stripped'));?>
					<div class="form-body">
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-8 col-md-4">
								<a href="<?=site_url('appweb/category-jobs');?>" class="btn btn-danger btn-sm btn-circle" name="back"><i class="fa fa-angle-left"></i> Back</a>
