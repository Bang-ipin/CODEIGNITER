...
class Landingpage_model extends CI_Model{
	...
	public function get_nine_gallery(){
	...
	public function get_six_testimoni(){
		return 	$this->db->order_by('id','desc')
						  ->limit(8)
						  ->get('testimoni')
						 ->result_array();
	...
	public function get_three_lastblog(){
	...
	public function get_eight_lastblog(){
		return 	$this->db   ->where('status',1)
		                    ->order_by('id','desc')
						    ->limit(9)
						    ->get('blog')
	...
	public function get_pop_lastblog(){
