										...
										<div class="col-md-10">
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="fileinput-new thumbnail" style="width: 300px; height: 300px;">
													<?php if(empty($image)){ ?>
														<img src="<?php echo base_url('assets/admin/img/no-image.jpg');?>" style="width:300px;height:300px;" alt="background"/>
													<?php }else{ ?>
														<img src="<?php echo base_url('assets/frontend/images/'.$image);?>" style="width:300px;height:300px;"  alt="background"/>
													<?php } ?>
												</div>
