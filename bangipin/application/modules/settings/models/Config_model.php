...
class Config_model extends CI_Model{
	...
	function Get_All(){
		...
		$this->db->select("id_config,nama,slogan,deskripsi_situs,meta_deskripsi,meta_keyword,telepon,alamat,email_website,pemilik, email_website,website,komentar,logo,maintenance,favicon,facebook,twitter,instagram,linkedin,youtube,tema");
		$this->db->limit(1);
