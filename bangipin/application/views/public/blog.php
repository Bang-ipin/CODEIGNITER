						  ...
						  <?php 
							...
							if (!empty($post['gambar'])){
									$gambar = "<a href=".base_url('files/media/'.$post['gambar'].'')." class='w-100 fancy-view'>
												<img class='lazy responsive' data-src=".base_url('files/media/'.$post['gambar'].'')."  alt='".strip_tags($post['judul_blog'])."' /></a>";
								}else{
									$gambar = "<a href=".base_url('assets/public/img/no-image.jpg')." class='w-100 fancy-view'>
												<img class='lazy img-responsive'  data-src=".base_url('assets/public/img/no-image.jpg')." alt='".strip_tags($post['judul_blog'])."' ></a>";
									}
								...
								<div class="row">
									...
									<div class="col-12 col-sm-7">
										...
										<div class="fables-forth-text-color font-14 my-2">                                  
											<span class="fa fa-user fables-second-text-color mr-1"></span> 
