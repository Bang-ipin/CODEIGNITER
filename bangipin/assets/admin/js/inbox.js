var AppInbox = function () {
    ...
    var loadInbox = function (el, name) {
        var url = base_url+ 'inbox/show_inbox';
    ...
    var loadMessage = function (el, name, resetMenu) {
        var url = base_url+ 'inbox/view_inbox';
    ...
    var initFileupload = function () {
        ...
        $('#fileupload').fileupload({
            ...
            url: base_url+'assets/plugins/jquery-file-upload/',
            autoUpload: true
        });
    ...
    var loadCompose = function (el) {
        var url = base_url+ 'inbox/tulis_pesan';
    ...
    var loadReply = function (el) {
        ...
        var url = base_url + 'inbox/balas_pesan';
    ...
    var loadSearchResults = function (el) {
        var url = base_url + 'inbox/cari_pesan';
...
jQuery(document).ready(function() {    
   AppInbox.init(); // init metronic core componets
});
