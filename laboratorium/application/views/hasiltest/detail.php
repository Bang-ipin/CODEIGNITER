...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
			...
			<td align="center" width="80" ><?php echo $this->app_model->tgl_indo($db['tgl_periksa']); ?></td>
			<td align="center" width="80" ><?php echo $db['kode_barcode']; ?></td>
			<td align="center" width="80" ><?php echo $db['nama_dokter']; ?></td>
			<td align="center" width="80" ><?php echo $db['pasien']; ?></td>
			...
			<td align="center" width="100" ><?php echo $db['nama_diagnosa']; ?></td>
			<td align="center" width="100" ><?php echo $db['hasil']; ?></td>
			<td align="center" width="100" ><?php echo $db['catatan']; ?></td>
        </tr>
    <?php
		$no++;
		}
