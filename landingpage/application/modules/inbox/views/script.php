	...
	jQuery(document).ready(function(){
		...
		function initWysihtml5() {
			$('.inbox-wysihtml5').wysihtml5({
				"stylesheets": ["<?=base_url('asset/global/plugins/bootstrap-wysihtml5/wysiwyg-color.css');?>"]
			});
		}
		...
		function initFileupload() {
			...
			$('#fileupload').fileupload({
				url: '<?=base_url('asset/global/plugins/jquery-file-upload/');?>',
				autoUpload: true
			});
		...
		function loadSearchResults (el) {
			var url = '<?=site_url('administrator/inbox/cari_pesan');?>';
