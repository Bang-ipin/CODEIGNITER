	...
	<div class="col-md-12">
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				<?php echo form_open_multipart('landingpage/landingpage/simpan_portofolio',array('class'=>"form-horizontal form-bordered form-row-stripped", 'id'=>""))?>
					<div class="tabbable">
						...
						<div class="tab-content no-space">
							...
							<div class="tab-pane active" id="tab_portofolio">
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<textarea class="form-control maxlength-handler" rows="8" name="deskripsivideo" maxlength="5000"><?=$deskripsivideo;?></textarea>
									...
									<div class="col-md-10">
										<div class="fileinput fileinput-new" data-provides="fileinput">
											<div class="fileinput-new thumbnail" style="width: 300px; height: 150px;">
												...
												<?php }else{ ?>
													<img src="<?php echo base_url('files/media/'.$image);?>" style="width:300px;height:150px;"  alt="background"/>
												<?php } ?>
											</div>
