									...
									<div class="col-md-10">
										<div class="fileinput fileinput-new" data-provides="fileinput">
											<div class="fileinput-new thumbnail" style="width: 150px; height: 60px;">
												<?php if(empty($lg)){ ?>
													<img src="<?php echo base_url('files/images/no-image.jpg');?>" style="width:150px;height:60px;" alt="Logo"/>
												<?php }else{ ?>
													<img src="<?php echo base_url('files/media/'.$lg);?>" style="width:150px;height:60px;"  alt="Logo"/>
												<?php } ?>
											</div>
											<div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 150px; max-height: 60px;"></div>
											<div>
