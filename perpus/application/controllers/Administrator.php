...
class Administrator extends CI_Controller {
	...
	public function cetaksemuaanggota()
	{
			...
			$d['judul'] 			= "Data Seluruh Anggota Perpustakaan";
	...
	{	
		$data['title'] = 'List Pemesanan Buku Perpustakaan'; 
	...
	public function cetakpembelajaran()
	{
		...
		$text = "SELECT judul_materi, nama_pengampu, kelas,link,tanggal_upload FROM materi";
		$d['query']= $this->db->query($text);
