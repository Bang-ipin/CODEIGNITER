...
function get_header()
{	
	inc_app('template','header');
}

function header_laporan()
{	
	include_once(APPPATH.'views/template/header_laporan.php');
}
function head_report()
{	
	inc_app('template','head_report');
}

function get_footer()
{	
	inc_app('template','footer');
}
...
function kplperpus()
{
	$CI=& get_instance();
	$CI->load->library('indonesia_library');
	return $CI->indonesia_library->carikepalaperpus();
}
function namayayasan()
{
    $CI=& get_instance();
    $CI->load->library('indonesia_library');
    return $CI->indonesia_library->carinamayayasan();
}
function sekolah()
{
    $CI=& get_instance();
    $CI->load->library('indonesia_library');
    return $CI->indonesia_library->carinamasekolah();
}
function instansi()
{
    $CI=& get_instance();
    $CI->load->library('indonesia_library');
    return $CI->indonesia_library->carinamainstansi();
}
function akreditasi()
{
    $CI=& get_instance();
    $CI->load->library('indonesia_library');
    return $CI->indonesia_library->carinamaakreditasi();
}
function alamat()
{
    $CI=& get_instance();
    $CI->load->library('indonesia_library');
    return $CI->indonesia_library->carinamaalamat();
}
