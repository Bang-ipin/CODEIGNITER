	...
	$(function(){
        $("#cetakpdf").click(function(e) {
			...
			if(	$tgl_awal == '' || $tgl_akhir == '')
			{
				...
				{
				window.open('<?php echo base_url()?>admin/cetakPdf/'+$tgl_awal+'/'+$tgl_akhir);
			}
        });
    });
	$(function(){
        $("#printpdf").click(function(e) {
				window.open('<?php echo base_url()?>admin/printpdf');
			});
        });
		
	$(function(){
        $("#printexcel").click(function(e) {
            	window.open('<?php echo base_url()?>admin/printexcel');
			});
        });
