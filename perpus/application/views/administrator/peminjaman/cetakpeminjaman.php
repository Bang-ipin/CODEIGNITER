<?php inc_app('template','head_report');?>
	...
	<?php if(isset($dari)){
		$title= "<div> Data Peminjaman Buku Perpustakaan dari tanggal ".$dari." sampai dengan tanggal ".$sampai." :</div></br>";
		}else{
			$title= "<div> Data Seluruh Peminjaman Buku Perpustakaan : </div>";
		}
		?>
