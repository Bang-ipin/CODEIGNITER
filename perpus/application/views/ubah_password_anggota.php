<?php echo form_open('change_password/ganti_pass', array('id' => 'UbahPass')); ?>
	<div class='form-group'>
		<label>Password Lama</label>
		<input type='password' name='pass_old' id='pass_old' class='form-control' placeholder='Password Lama' autofocus="autofocus">
	</div>
	<div class='form-group'>
	...
	form.validate({
		...
		rules:{
			pass_old: {
				required: true,
				remote:{
					url:"<?=site_url('welcome/cek_password_anggota');?>",
					type:"POST",
					dataType:"json",
					data:{
						pass_old:function(){
