					...
					<div class="col-sm-12">
						<div class="box">
							<div class="box-body">
								...
								<?php echo form_open_multipart('admin/simpaneditrak',array('onsubmit'=>'return validasi(this)'));?> 
									<div class="form-horizontal">
										<div class="form-group">
											...
											<div class="col-xs-5">
												<input type="text" class="form-control" value="<?php echo $rows->id_rak;?>" name="id" id="id" readonly="readonly"  >
											</div>
										</div>
										<div class="form-group">
											<div class="col-xs-3">
										...
										<div class="form-group">
											...
											<div class="col-xs-5">
												<input type="text" class="form-control" name="namarak" id="namarak" value="<?php echo $rows->nama_rak?>">
											</div>
										</div>
										<div class="form-group">
											<div class="col-xs-3">
