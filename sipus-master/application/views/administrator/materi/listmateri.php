<style type="text/css">
					...
					<div class="col-sm-12">
						<div class="box">
							<div class="box-header ">
								<a href="<?=base_url('administrator/cetakpembelajaran')?>" class="btn btn-default" target="_blank">
								<img src="<?php echo base_url();?>asset/plugins/easyui/themes/icons/print.png" title="Cetak Pembelajaran"></img> Cetak</a>
							</div>
							<div class="box-body">
	...
	<script type="text/javascript">
		...
		function view(id) {
			...
			$.ajax({
				type	: 'POST',
				url		: "<?php echo site_url('administrator/datamateri'); ?>",
				data	: "id="+id,
				cache	: false,
