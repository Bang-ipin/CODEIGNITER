<script type="text/javascript">
    ...
    $(function(){
        $("#btnCari").click(function(e) {
			...
			$.ajax({
					type: "POST",
					url: "<?=base_url('administrator/caripeminjambuku');?>",
					dataType: "html",
	...
	$(function(){
        $("#all").click(function(e) {
            $.ajax({
				type: "POST",
				url: "<?=base_url('administrator/semuapeminjambuku');?>",
				data: $('form').serialize(),
				cache:false,
				success	: function(data){
					var win = $.messager.progress({
											...
											<div class="form-horizontal">
												<div class="form-group">
													...
													<div class="col-xs-8">
														...
														<button id="all" name="submit" type="submit" class="easyui-linkbutton" data-options="iconCls:'icon-search'" style="width:250px;margin: 5px;">Semua Peminjam Buku</button>
													</div>
												</div>
											</div>
										</div>
