...
class Lap_bk extends CI_Controller {	
	...
	$this->load->view('gudang/laporan_keluar');
	...
	public function cari()
	{
        ...
        $this->load->view('gudang/vlapkeluar',$data);
    }
	...
	{	
		...
		$this->load->view('gudang/cetakdistribusiPdf',$data);
	...
	public function cetakexcel()
	{
		...
		$this->load->view('gudang/cetakdistribusiExcel',$data);
