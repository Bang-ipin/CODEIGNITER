...
class Lap_bk extends CI_Controller {	
	...
	$this->load->view('pimpinan/laporan_keluar');
	...
	public function cari()
	{
        ...
        $data=array(
            'query'=> $this->Laporan_model->getLapDistribusi($tgl_awal,$tgl_akhir),
        ...
        $this->load->view('pimpinan/vlapkeluar',$data);
    }
	...
	{
		$data=array(
            'query'=> $this->Laporan_model->getLapDistribusiAll(),
        );
        $this->load->view('pimpinan/vlapkeluar',$data);
    }
	...
	{	
		...
		$this->load->view('pimpinan/cetakdistribusiPdf',$data);
        ...
        $this->dompdf->render();
        $this->dompdf->stream("Laporan-Distribusi-Barang-Dari-Gudang.pdf", array('Attachment'=>0));
	...
	{	
		$data=array(
		   	'title'=>'Data Penjualan Barang Gudang',
	    	'query'=> $this->Laporan_model->getLapDistribusiAll(),
	        );
		$this->load->view('pimpinan/cetakdistribusiPdf',$data);
		$paper_size  = 'A4'; //paper size
	...
	public function cetakexcel()
	{
		...
		$this->load->view('pimpinan/cetakdistribusiExcel',$data);
