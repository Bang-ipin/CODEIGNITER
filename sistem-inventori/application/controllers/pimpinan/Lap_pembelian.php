...
class Lap_pembelian extends CI_Controller {	
	...
	$this->load->view('pimpinan/laporan_masuk');
	...
	public function cari()
	{
        ...
        $this->load->view('pimpinan/vlapmasuk',$data);
    }
	...
	{	
		...
		$this->load->view('pimpinan/cetakmasukPdf',$data);
        ...
        $this->dompdf->render();
        $this->dompdf->stream("laporanpembelian.pdf", array('Attachment'=>0));
	...
	public function cetakexcel()
	{
		...
		$this->load->view('pimpinan/cetakmasukExcel',$data);
