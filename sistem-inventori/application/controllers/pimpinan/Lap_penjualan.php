...
class Lap_penjualan extends CI_Controller {	
	...
	{	
		...
		$this->load->view('pimpinan/cetakPenjualanPdf',$data);
        ...
        $this->dompdf->render();
        $this->dompdf->stream("LaporanPenjualanToko.pdf", array('Attachment'=>0));
	...
	public function cetakexcel()
	{
		...
		$this->load->view('pimpinan/cetakPenjualanExcel',$data);
