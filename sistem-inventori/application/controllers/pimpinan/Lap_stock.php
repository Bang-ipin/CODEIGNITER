...
class Lap_stock extends CI_Controller {	
	...
	$this->load->view('pimpinan/laporan_stock',$data);
	...
	public function lihat()
	{
		...
		$this->load->view('pimpinan/lap_view',$d);
	...
	public function cetakpdf()
	{
        ...
        $this->load->view('pimpinan/cetakpdf', $data);
	...
	public function cetakexcel()
	{
        ...
        $this->load->view('pimpinan/cetakexcel', $data);
	}
