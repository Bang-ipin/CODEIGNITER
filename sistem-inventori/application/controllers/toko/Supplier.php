...
Class Supplier extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('gudang/list_supplier',$data);
	...
	public function tambah_supplier(){
		...
		$this->load->view('gudang/template/header');
		$this->load->view('gudang/template/menu');
		$this->load->view('gudang/tambah_supplier',$data);
		$this->load->view('gudang/template/footer');
	}
	...
	public function tambah_supplier_proses()
	{
		...
		$data=array(
			...
			redirect(base_url('gudang/supplier'));
		}
	}
	...
	public function edit_supplier($id){
		...
		$this->load->view('gudang/template/header');
		$this->load->view('gudang/template/menu');
		$this->load->view('gudang/edit_supplier',$data);
		$this->load->view('gudang/template/footer');
		}
