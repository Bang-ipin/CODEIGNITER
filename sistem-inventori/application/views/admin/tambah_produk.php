					...
					<div class="col-sm-12">
						<div class="box">
							<div class="box-body">
								...
								<form class="form" action="<?=base_url('admin/produk/tambah_produk_proses');?>" method="post">
									<div class="form-horizontal">
										...
										<div class="form-group">
											<label class="col-xs-3" for="Jenis">Jenis Barang</label>
												<div class="col-xs-6"><?php echo form_dropdown('Jenis',$dd_jenis,$jenis_selected,$attribute);?>
											</div>
										</div>
										...
										<div class="form-group">
											<label class="col-xs-3" for="Stock">Jumlah</label>
											<div class="col-xs-5">
