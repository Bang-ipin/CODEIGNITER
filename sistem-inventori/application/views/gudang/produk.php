					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header bg-aqua">
								<a href="<?=base_url('gudang/produk/tambah_produk')?>" class="btn btn-default">
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td>
														<a href="<?php echo base_url()?>gudang/produk/edit/<?php echo $rows->kode_barang?>" class="btn-link btn-xs"><img src="<?php echo base_url();?>asset/easyui/themes/icons/pencil.png"></img></a>
														<a href="<?php echo base_url()?>gudang/produk/delete/<?php echo $rows->kode_barang?>" class="btn-link btn-xs" onclick="return confirm('Anda Yakin menghapus data ini?')"><img src="<?php echo base_url();?>asset/easyui/themes/icons/no.png"></img></a>
													</td>
												</tr>
											<?php }	?>
										</tbody>
