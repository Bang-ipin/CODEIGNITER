...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?=config_item('asset')?>/plugins/iCheck/all.css">
		...
		<script type="text/javascript" src="<?=config_item('asset')?>/plugins/iCheck/icheck.min.js"></script>
