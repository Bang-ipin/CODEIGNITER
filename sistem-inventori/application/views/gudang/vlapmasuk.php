...
<style type="text/css">
	...
	<?php if(isset($tgl_awal)){
				echo "<div class='alert alert-info'>Data transaksi pembelian dari tanggal ".$tgl_awal." sampai dengan tanggal ".$tgl_akhir." adalah sebagai berikut:<button type='button' class='close' data-dismiss='alert'>&times;</button></div>
				...
				echo "<div class='alert alert-info'>Data semua transaksi pembelian sebagai berikut: <button type='button' class='close' data-dismiss='alert'>&times;</button></div>
...
<script type="text/javascript">
	$(function(){
        $("#cetakpdf").click(function(e) {
			...
			if(	$tgl_awal == '' || $tgl_akhir == '')
			{
				...
				{
				window.open('<?php echo base_url()?>gudang/lap_bm/cetakPdf/'+$tgl_awal+'/'+$tgl_akhir);
			}
        });
    });
	$(function(){
        $("#cetakexcel").click(function(e) {
			...
			if(	$tgl_awal == '' || $tgl_akhir == '')
			{
				...
				{
				window.open('<?php echo base_url()?>gudang/lap_bm/cetakexcel/'+$tgl_awal+'/'+$tgl_akhir);
			}
        });
    });
	...
	$(function(){
        $("#printpdf").click(function(e) {
				window.open('<?php echo base_url()?>gudang/lap_bm/printpdf');
			});
        });
		
	$(function(){
        $("#printexcel").click(function(e) {
            	window.open('<?php echo base_url()?>gudang/lap_bm/printexcel');
			});
        });
