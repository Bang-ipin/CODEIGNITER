...
<body>
	<div id="title">
		<br>
		<?php if(isset($dari)){
					echo "<div> Data Penjualan Barang Toko Mundu dari tanggal ".$dari." sampai dengan tanggal ".$sampai." :</div></br>";
				}else{
					echo "<div> Data Seluruh Transaksi Penjualan Barang Toko Mundu : </div>";
				}
		?>
		<br>
	</div>
