<?php
    ...
    header ("Content-Disposition: attachment; filename=Cetak-Laporan-Penjualan-Barang-Toko-Ringroad.xls");
    ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div id="title">
		<br>
		<?php if(isset($dari)){
					echo "<div> Data Penjualan Barang Toko Ring Road dari tanggal ".$dari." sampai dengan tanggal ".$sampai." :</div></br>";
				}else{
					echo "<div> Data Seluruh Transaksi Penjualan Barang Toko Ring Road : </div>";
				}
		?>
		<br></div>
