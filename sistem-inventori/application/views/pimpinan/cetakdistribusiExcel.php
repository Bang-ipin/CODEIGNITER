<?php
    ...
    header ("Content-Disposition: attachment; filename=Cetak-Laporan-Distribusi-Barang.xls");
    ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div id="title">
		<br>
		<?php if(isset($dari)){
					echo "<div> Data Distribusi Barang dari Gudang ke Toko dari tanggal ".$dari." sampai dengan tanggal ".$sampai." :</div></br>";
				}else{
					echo "<div> Data Seluruh Distribusi Barang dari Gudang Ke Toko : </div>";
				}
		?>
	</div>
	<table id="table" class="table-bordered table-striped">
		...
		if(!empty($query)){
			...
			<tr>
				...
				<td align="center">Rp. <?php echo number_format($rows->harga_beli,2,',','.');?></td>
