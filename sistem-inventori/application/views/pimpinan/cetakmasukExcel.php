<?php
    ...
    header ("Content-Disposition: attachment; filename=Cetak-Laporan-Barang-Masuk-Gudang.xls");
    ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div id="title">
		<?php if(isset($dari)){
					echo "<div> Data Pembelian Barang Gudang dari tanggal ".$dari." sampai dengan tanggal ".$sampai." :</div></br>";
				}else{
					echo "<div> Data Seluruh Pembelian Barang Gudang : </div>";
				}
		?>
	</div>
	<table id="table" class="tabel table-bordered table-stripped">
		...
		if(!empty($query)){
			...
			<tr>
				...
				<td><?php echo date("d M Y",strtotime($rows->tanggal_transaksi));?></td>
