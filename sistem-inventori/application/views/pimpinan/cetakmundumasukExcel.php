<?php
    ...
    header ("Content-Disposition: attachment; filename=Cetak-Laporan-Pembelian-Toko-Mundu.xls");
    ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div id="title">
		<?php if(isset($dari)){
					echo "<div> Data Pembelian Toko Mundu dari tanggal ".$dari." sampai dengan tanggal ".$sampai." :</div></br>";
				}else{
					echo "<div> Data Seluruh Pembelian Toko Mundu : </div>";
				}
		?>
	</div>
