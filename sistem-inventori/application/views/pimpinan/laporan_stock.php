	...
	$(document).ready(function(){
		...
		$("#cari").click(function(){
			...
			if(jml_pilih.length == 0){
			 ...
			 $.ajax({
				type	: "POST",
				url		: "<?= base_url(); ?>/pimpinan/lap_stock/lihat",
				data	: string,
				cache	: false,
		...
		$("#cetak").click(function(){
			...
			if(jml_pilih.length == 0){
			 ...
			 window.open('<?=base_url();?>pimpinan/lap_stock/cetakpdf/'+pilih+'/'+kode);
			return false();
		});
		$("#cetakexcel").click(function(){
			...
			if(jml_pilih.length == 0){
			 ...
			 window.open('<?=base_url();?>pimpinan/lap_stock/cetakexcel/'+pilih+'/'+kode);
			return false();
		});
					...
					<div class="col-md-12">
						<div class="box">
							<div class="box-header bg-aqua">
								<h3 class="box-title">Laporan Stok Barang Gudang</h3>
							</div>
							<div class="box-body">
