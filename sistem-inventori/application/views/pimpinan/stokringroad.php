	...
	$(document).ready(function(){
		...
		$("#cari").click(function(){
			...
			if(jml_pilih.length == 0){
			 ...
			 $.ajax({
				type	: "POST",
				url		: "<?= base_url(); ?>/pimpinan/st_tokoringroad/lihat",
				data	: string,
				cache	: false,
		...
		$("#cetak").click(function(){
			...
			if(jml_pilih.length == 0){
			 ...
			 window.open('<?=base_url();?>pimpinan/st_tokoringroad/cetakpdf/'+pilih+'/'+kode);
			return false();
		});
		$("#cetakexcel").click(function(){
			...
			if(jml_pilih.length == 0){
			 ...
			 window.open('<?=base_url();?>pimpinan/st_tokoringroad/cetakexcel/'+pilih+'/'+kode);
			return false();
		});
					...
					<div class="col-md-12">
						<div class="box">
							<div class="box-header bg-aqua">
								<h3 class="box-title">Laporan Stok Barang Toko Ring Road</h3>
							</div>
							<div class="box-body">
