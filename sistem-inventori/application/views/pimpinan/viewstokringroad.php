	...
	<table id="table" class="table-bordered table-striped" width="100%">
		...
		<tbody>
			...
			<tr>
				...
				<td align="right" width="100" ><?php echo number_format($db->harga_beli,2,',','.'); ?></td>
				<td align="right" width="100" ><?php echo number_format($db->harga_jual,2,',','.'); ?></td>
				<td align="center" width="80" ><?php echo $db->stok; ?></td>
