...
<div>&nbsp </div>
	<?php if(isset($tgl_awal))
		{
			echo"<div class='alert alert-info'>Data transaksi penjualan dari tanggal ".$tgl_awal." sampai dengan tanggal ".$tgl_akhir." adalah sebagai berikut:<button type='button' class='close' data-dismiss='alert'>&times;</button></div>
			...
			echo "	<div class='alert alert-info'>Data semua transaksi penjualan sebagai berikut: <button type='button' class='close' data-dismiss='alert'>&times;</button></div>
	...
	$(function(){
        $("#cetakpdf").click(function(e) {
			...
			if(	$tgl_awal == '' || $tgl_akhir == '')
			{
				...
				{
				window.open('<?php echo base_url()?>pimpinan/lap_bk/cetakPdf/'+$tgl_awal+'/'+$tgl_akhir);
			}
        });
    });
	$(function(){
        $("#cetakexcel").click(function(e) {
			...
			if(	$tgl_awal == '' || $tgl_akhir == '')
			{
				...
				{
				window.open('<?php echo base_url()?>pimpinan/lap_bk/cetakexcel/'+$tgl_awal+'/'+$tgl_akhir);
			}
        });
    });
	$(function(){
        $("#printpdf").click(function(e) {
				window.open('<?php echo base_url()?>pimpinan/lap_bk/printpdf');
			});
        });
		
	$(function(){
        $("#printexcel").click(function(e) {
            	window.open('<?php echo base_url()?>pimpinan/lap_bk/printexcel');
			});
        });
