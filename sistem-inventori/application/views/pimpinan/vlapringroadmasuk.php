...
$(function(){
        $("#cetakpdf").click(function(e) {
			...
			if(	$tgl_awal == '' || $tgl_akhir == '')
			{
				...
				{
				window.open('<?php echo base_url()?>pimpinan/lap_beliringroad/cetakPdf/'+$tgl_awal+'/'+$tgl_akhir);
			}
        });
    });
	$(function(){
        $("#cetakexcel").click(function(e) {
			...
			if(	$tgl_awal == '' || $tgl_akhir == '')
			{
				...
				{
				window.open('<?php echo base_url()?>pimpinan/lap_beliringroad/cetakexcel/'+$tgl_awal+'/'+$tgl_akhir);
			}
        });
    });
	...
	$(function(){
        $("#printpdf").click(function(e) {
				window.open('<?php echo base_url()?>pimpinan/lap_beliringroad/printpdf');
			});
        });
		
	$(function(){
        $("#printexcel").click(function(e) {
            	window.open('<?php echo base_url()?>pimpinan/lap_beliringroad/printexcel');
			});
        });
