...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?=config_item('asset')?>/jqGrid/css/ui-jqgrid.css"  type="text/css">
		<link rel="stylesheet" href="<?=config_item('asset')?>/dist/css/skins/_all-skins.css">
		<!-- Javascript-->
		<script type="text/javascript" src="<?=config_item('asset');?>/bootstrap/js/jquery.min.js"></script>
		<script type="text/javascript" src="<?=config_item('asset');?>/jqGrid/js/jquery.jqGrid.min.js"></script>
		<script type="text/javascript" src="<?=config_item('asset');?>/validation/dist/jquery.validate.js"></script>
		...
		<script type="text/javascript" src="<?=config_item('asset');?>/chartjs/Chart.bundle.js"></script>
		<script type="text/javascript" src="<?=config_item('asset');?>/chartjs/samples/utils.js"></script>
		...
		<script type="text/javascript" src="<?=config_item('asset');?>/dist/js/app.js"></script>
