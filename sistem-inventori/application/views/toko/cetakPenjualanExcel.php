...
<body>
	<div id="title">
		<br>
		<?php if(isset($dari)){
					echo "<div> Data Penjualan Toko Ring Road dari tanggal ".$dari." sampai dengan tanggal ".$sampai." :</div></br>";
				}else{
					echo "<div> Data Seluruh Transaksi Penjualan Toko Ring Road : </div>";
				}
		?>
		<br></div>
