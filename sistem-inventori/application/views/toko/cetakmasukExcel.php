<?php
    ...
    header ("Content-Disposition: attachment; filename=Cetak-Laporan-Pembelian-Toko_ringroad.xls");
    ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div id="title">
		<?php if(isset($dari)){
					echo "<div> Data Pembelian Toko Ring Road dari tanggal ".$dari." sampai dengan tanggal ".$sampai." :</div></br>";
				}else{
					echo "<div> Data Seluruh Pembelian Toko Ringroad : </div>";
				}
		?>
	</div>
