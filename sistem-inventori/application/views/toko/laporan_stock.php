	...
	$(document).ready(function(){
		...
		$("#cari").click(function(){
			...
			if(jml_pilih.length == 0){
			 ...
			 $.ajax({
				type	: "POST",
				url		: "<?= base_url(); ?>/toko_ringroad/lap_stock/lihat",
				data	: string,
				cache	: false,
		...
		$("#cetak").click(function(){
			...
			if(jml_pilih.length == 0){
			 ...
			 window.open('<?=base_url();?>toko_ringroad/lap_stock/cetakpdf/'+pilih+'/'+kode);
			return false();
		});
		$("#cetakexcel").click(function(){
			...
			if(jml_pilih.length == 0){
			 ...
			 window.open('<?=base_url();?>toko_ringroad/lap_stock/cetakexcel/'+pilih+'/'+kode);
			return false();
		});
