					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header bg-aqua">
								<a href="<?=base_url('toko_ringroad/stok_toko/add')?>" class="btn btn-default">
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td align="center"><?php echo $rows->stok;?></td>
													<td align="center"><?php echo $rows->nama_satuan;?></td>
													<td>
														<a href="<?php echo base_url()?>toko_ringroad/stok_toko/edit/<?php echo $rows->kode_barang?>" class="btn-link btn-xs"><img src="<?php echo base_url();?>asset/easyui/themes/icons/pencil.png"></img></a>
														<a href="<?php echo base_url()?>toko_ringroad/stok_toko/delete/<?php echo $rows->kode_barang?>" class="btn-link btn-xs" onclick="return confirm('Anda Yakin menghapus data ini?')"><img src="<?php echo base_url();?>asset/easyui/themes/icons/no.png"></img></a>
													</td>
												</tr>
											<?php }	?>
										</tbody>
