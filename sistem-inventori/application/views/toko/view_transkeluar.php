									...
									<form action="<?=base_url('toko_ringroad/penjualan/checkout')?>" method="post" onsubmit="return validasi(this)">
										<div class="form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-xs-6">
													<input class="form-control" name="tanggal"  id="tanggal" data-options="validType:'length[3,10]'" value="<?php echo $tanggal;?>" readonly="true">
												</div>
											</div>
											<div class="form-group">
												<div class="col-xs-3">
												...
												<div class="col-xs-7">
													<input type="text" class="form-control" name="toko" readonly="true" value="<?=$pelanggan;?>" />
												</div>
											</div>
											<hr>
												...
												<table class="table-bordered table-striped" width="100%">
													...
													<tbody>
														...
														<tr>
															...
															<td style="text-align:center">Rp.<?php echo $this->cart->format_number($items->harga_jual); ?></td>
											...
											<div>&nbsp;</div>
												<a href="<?=base_url('toko_ringroad/penjualan')?>" class="btn btn-danger" >Kembali</a>
										</div>
									</form>
								</div>
							</div>
