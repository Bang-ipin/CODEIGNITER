	...
	background-color: #fece2f;
					...
					<div class="col-sm-12">
						<div class="box"> 
							<div class="box-header ">
								<a class="btn btn-default" href="<?=base_url();?>admin/tambahinvoice">
										...
										if(isset($query)){
											...
											?>
												<tr>
													...
													<td align="center"><?php echo $this->M_admin->tgl_indo($rows->tanggal);?></td>
													<td align="center"><?php echo $rows->pelanggan;?></td>
													<td align="center"><?php echo $rows->kota;?></td>
													<td align="center">
														<a href="<?php echo base_url().'admin/cetakinvoice/'.$rows->kodeinvoice;?>" target="_blank">
		...
		function hapusdata(hapus) {
			...
			if(Ya){
				$.ajax({
				type: 'POST',
				url: '<?= base_url('admin/hapusinvoice');?>',
				dataType: "html",
				data: 'id='+hapus,
				cache	:false,
				success	: function(Ya){
				var win = $.messager.progress({
						...
						setTimeout(function(){
							...
							window.location.reload('<?php echo base_url('admin/invoice');?>').html(Ya);
							},2800)
						}
					});
				}
		...
		function view(invoice) {
			...
			$.ajax({
				type	: 'POST',
				url		: "<?php echo site_url('admin/datainvoice'); ?>",
				data	: "id="+invoice,
				cache	: false,
