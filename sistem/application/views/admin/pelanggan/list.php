<style type="text/css">
									...
									<table id="table" class="table-bordered table-striped" width="100%">
										...
										<tbody>
											...
											<tr>
												...
												<td align="center"><?php echo $this->M_admin->tgl_indo($rows->tanggal_invoice);?></td>
												...
												<td align="center"><?php echo $this->M_admin->tgl_indo($rows->ttl);?></td>
												...
												<td align="center" width="15%">
													<a href="<?php echo base_url().'admin/editpostingan/';?><?php echo $rows->id;?>" class="btn btn-link btn-xs"><img src="<?php echo base_url();?>asset/plugins/easyui/themes/icons/pencil.png"></img></a>
	...
	function hapusdata(hapus) {
		...
		if(Ya){
			$.ajax({
            type: 'POST',
            url: '<?= base_url('admin/hapuspelanggan');?>',
            dataType: "html",
			data: 'id='+hapus,
			cache	:false,
			success	: function(Ya){
			var win = $.messager.progress({
					...
					setTimeout(function(){
						...
						window.location.reload('<?php echo base_url('admin/pelanggan/list');?>').html(Ya);
						},2800)
					}
				});
			}
