						...
						<div class="col-xs-12">
							<div class="box">
								<div class="box-body">
									...
									<?=form_open('admin/updatepostingan',array('name'=>'form','id'=>"form"))?>
										<div class="form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<input type="text" class="form-control uneditable-input" name="pelanggan" id="pelanggan" readonly="true" value="<?php echo $row->pelanggan;?>" />
												</div>
											</div>
											<div class="form-group">
												<div class="col-md-3">
												...
												<div class="col-md-4">
													<input type="text" class="form-control uneditable-input" name="institusi" id="institusi" readonly="true" value="<?php echo $row->institusi;?>" />
												</div>
											</div>
											<div class="form-group">
												<div class="col-md-3">
												...
												<div class="col-md-3">
													<input type="text" class="form-control uneditable-input" name="kota" id="kota" readonly="true" value="<?php echo $row->kota;?>"/>
												</div>
											</div>
											<div class="form-group">
												<div class="col-md-3">
												...
												<div class="col-md-4">
													<input type="text" class="form-control uneditable-input" name="email" id="email" readonly="true" value="<?php echo $row->email;?>" />
												</div>
											</div>
											<div class="form-group">
												<div class="col-md-3">
												...
												<div class="col-md-4">
													<input type="text" class="form-control uneditable-input" name="telepon" id="telepon" readonly="true" value="<?php echo $row->telepon;?>" />
												</div>
											</div>
											<div class="form-group">
												<div class="col-md-3">
												...
												<div class="col-md-4">
													<input type="text" class="form-control uneditable-input" name="lahir" id="lahir" readonly="true" value="<?php echo $row->ttl;?>" />
												</div>
											</div>
											<div class="form-group">
												<div class="col-md-3">
