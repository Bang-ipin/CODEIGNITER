...
$(document).ready(function(){
	...
	function tampil_data(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url('administrator/datadetail'); ?>",
			data	: "kode="+kode,
			cache	: false,
	...
	$("#form").on('submit',function(event){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url('administrator/simpaninvoice'); ?>",
			data	: string,
	...
	$("#cetak").click(function(){
		var kode	= $("#kodeinvoice").val();
		window.open('<?php echo site_url();?>administrator/cetakinvoice/'+kode);
		return;
	});
