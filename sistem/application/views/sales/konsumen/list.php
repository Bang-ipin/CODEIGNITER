<style type="text/css">
										...
										<tbody>
											...
											<tr>
												...
												<td align="center" width="15%">
													<a href="<?php echo base_url().'sales/editkonsumen/';?><?php echo $rows->id;?>" class="btn btn-link btn-xs"><img src="<?php echo base_url();?>asset/plugins/easyui/themes/icons/pencil.png"></img></a>
	...
	function hapusdata(hapus) {
		...
		if(Ya){
			$.ajax({
            type: 'POST',
            url: '<?= base_url('sales/hapuskonsumen');?>',
            dataType: "html",
			data: 'id='+hapus,
			cache	:false,
			success	: function(Ya){
			var win = $.messager.progress({
					...
					setTimeout(function(){
						...
						window.location.reload('<?php echo base_url('sales/konsumen/list');?>').html(Ya);
						},2800)
					}
				});
			}
