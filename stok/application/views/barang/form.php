...
<tr>    
	<td>Nama Barang</td>
    <td>:</td>
    <td><input type="text" name="nama_brg" id="nama_brg"  size="50" maxlength="50" class="easyui-validatebox" data-options="required:true,validType:'length[3,25]'" value="<?php echo $nama_brg;?>"/></td>
</tr>
<tr>    
	<td>Satuan</td>
    <td>:</td>
