...
<div style="float:left; padding-bottom:5px;">
<form name="form" method="post" action="<?php echo base_url();?>barang">
...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <a href="<?php echo base_url();?>barang/edit/<?php echo $db['kode_barang'];?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>
            <a href="<?php echo base_url();?>barang/hapus/<?php echo $db['kode_barang'];?>"
