...
<div class="header" style="height:70px;background:white;padding:2px;margin:0;">	
        ...
        <img src='<?php echo base_url();?>asset/images/logo.png' style="padding:0; margin:0;" width="85" height="71">
        </div>
	...
	<div class="panel-header" fit="true" style="height:21px;padding-top:1px;padding-right:20px">
		<div style="float:left;">
			<a style="color:#fff;" href="<?php echo base_url();?>home" class="easyui-linkbutton" data-options="plain:true" iconCls="icon-home">Home</a>
            <a style="color:#fff;" href="<?php echo base_url();?>login/logout" class="easyui-linkbutton" data-options="plain:true" iconCls="icon-logout">Logout</a>
		</div>
    ...
    <div id="kiri" style="float:left;">
        ...
        <a href="<?php echo base_url();?>foto" title="Edit Foto">
