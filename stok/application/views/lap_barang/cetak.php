...
function myfooter(){	
    ...
    <tr>
        ...
        <td align="center"><?php echo $beli/1000;?></td>
        <td align="center"><?php echo $jual/1000;?></td>
        <td align="center"><?php echo $stok/1000;?></td>
    </tr>
    <?php
	$no++;
	}
...
<tr>
    ...
    Bantul, <?php echo $this->app_model->tgl_indo(date('Y-m-d'));?>
    <br /><br /><br /><br />
