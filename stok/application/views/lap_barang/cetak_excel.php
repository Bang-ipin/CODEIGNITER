...
<?php
    ...
    <tr>
        ...
        <td align="center"><?php echo number_format($beli)/1000;?></td>
        <td align="center"><?php echo number_format($jual)/1000;?></td>
        <td align="center"><?php echo number_format($stok)/1000;?></td>
    </tr>
    <?php
	$no++;
	}
