...
<div title="Transaksi" data-options="iconCls:'icon-tip'" style="overflow:auto;padding:5px 0px;">
    ...
    <ul class="easyui-tree">
    <li data-options="iconCls:'icon-surat_keputusan'">
    <a href="<?php echo base_url();?>pembelian">Barang Masuk</a>
    </li>
    <li data-options="iconCls:'icon-surat_keluar'">
    <a href="<?php echo base_url();?>penjualan">Barang Keluar</a>
    </li>
    </ul>
    </div>
</div>
<div title="Laporan" data-options="iconCls:'icon-print'" style="overflow:auto;padding:5px 0px;">
    ...
    <ul class="easyui-tree">
    <li>
    <span><a href="<?php echo base_url();?>lap_barang">Stok Akhir Barang</a></span>
    </li>
    <li>
    <span><a href="<?php echo base_url();?>lap_beli">Barang Masuk</a></span>
    </li>
    <li>
    <span><a href="<?php echo base_url();?>lap_jual">Barang Keluar</a></span>
    </li>
    </ul>
    </div>
</div>
<div title="Grafik" data-options="iconCls:'icon-grafik'" style="overflow:auto;padding:5px 0px;">
    ...
    <ul class="easyui-tree">
    <li>
    <span><a href="<?php echo base_url();?>grafik_beli">Barang Masuk</a></span>
    </li>
    <li>
    <span><a href="<?php echo base_url();?>grafik_jual">Barang Keluar</a></span>
    </li>
	</ul>
    </div>
</div>