...
<a href="<?php echo base_url();?>penjualan/tambah">
...
<form name="form" method="post" action="<?php echo base_url();?>penjualan">
...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
			...
			?>
            <a href="<?php echo base_url();?>penjualan/edit/<?php echo $db['kodejual'];?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>
            <a href="<?php echo base_url();?>penjualan/hapus/<?php echo $db['kodejual'];?>"
